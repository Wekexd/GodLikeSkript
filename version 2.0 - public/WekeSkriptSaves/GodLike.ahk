...
;	sleep 5000
	...
	sendinput {enter}
	sleep 200
	chatmsgpage = https://pastebin.com/raw/31sTPifP
	IfNotExist, %A_WorkingDir%\Weke Options
	{
		FileCreateDir, %A_WorkingDir%\Weke Options
	}
	FileDelete %A_WorkingDir%\Weke Options\chatmsg.html
	urldownloadtofile, %chatmsgpage% , %A_WorkingDir%\Weke Options\chatmsg.html
	FileRead , chatmessage , %A_WorkingDir%\Weke Options\chatmsg.html
	if chatmessage != null
	{
		sleep 3000
		sendinput {%przyciskDoOtwarciaChatu%}
...
;-2020-07-07-01:33-I think this is done.-
;-New Version: GodLike Java Edition-
