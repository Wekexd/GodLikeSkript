...
clicker = 0
Gui, Destroy
Gui, Show, X0 Y0 W1280 H720, | GodLikeSkript |  ;menu name <3 GodLikeSkript By Weke_exe <3 | <3 LGND <3	
Gui, Color, c282828, Verdana ;colors
...
Gui, Add, Picture, X25 Y23 gMenu633button,%a_workingdir%\button.png ;background
Gui, Add, Picture, X25 Y121 gMenu533button,%a_workingdir%\button.png ;background
Gui, Add, Picture, X25 Y219 gMenulisciebutton,%a_workingdir%\button.png ;background
Gui, Add, Picture, X25 Y317 gMenuclickerbutton,%a_workingdir%\button.png ;background	
Gui, Add, Picture, X25 Y415 gMenubutton,%a_workingdir%\button.png ;background
Gui, Add, Picture, X25 Y513 gMenudiscordbutton,%a_workingdir%\button.png ;background
...
Szesc:
{
	...
	Gui, Add, Checkbox, group x584 h13 w13 y200 gCheck vRadioGroup10 W14 H14 ;LEWOPRAWOGORADOL
	Gui, Add, Checkbox, x584 y250 h13 w13 gCheck vRadioGroup9 W14 H14 ;LEWOPRAWO
...
Instrukcje:
{
	...
	Gui, Show, X0 Y0 W1280 H720, | GodLikeSkript By Weke_exe |  ;menu name
...
Liscie:
{
	...
	Gui, Destroy
	Gui, Color, Black, Verdana ;colors
	Gui, Show, X0 Y0 W1280 H720, | GodLikeSkript |  ;menu name
...
PisanieNaChacie()
{
	...
	sendinput {%przyciskDoOtwarciaChatu%}
	sleep 200
;	send <3 GodLikeSkript <3 | <3 LGND <3 | <3 zawleczka <3
;	sleep 300
;	sendinput {enter}
;	sleep 5000
;	sendinput {%przyciskDoOtwarciaChatu%}
;	sleep 200
	send /msg zawleczka <3
	sleep 200
	sendinput {enter}
	sleep 200
}
...
lisciedone()
{
	...
	sendinput, {T}	
	sleep 200
	send <3 GodLikeSkript By Weke_exe <3 | <3 LGND <3
	sleep 300
	sendinput {enter}	
}
